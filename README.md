...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/aurora-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=13186&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/aurora-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `aurora` can be installed with:

```
conda install aurora
```

It is possible to list all of the versions of `aurora` available on your platform with:
